const translations = {
    en: {
        ...
        "about-para-1": "I am a Guidance, Navigation, and Control (GNC) and Attitude Determination and Control Systems (ADCS) engineer, specializing in active space debris mitigation and high-dynamic flight control loops. My technical foundation spans presenting space debris stabilization laws at the European Space Agency (ESA/ESTEC), simulating hybrid rocket combustion systems in Japan, and directing competitive student UAV groups.",
        "about-para-2": "Having operated within both European corporate aerospace standard environments (such as Boeing and ESA projects) and the intense academic engineering culture of Kyushu University (Planet Q Rocketry Club), I teach the \"street-smart\" systems architecture universities skip.",
        ...
        "teaser-desc": "University teaches you how to calculate. We teach you how to survive and thrive. Join the elite cohort of future aerospace and systems engineers. Accelerate your career from basic student to premium systems architect.",
        ...
        "teaser-waitlist-header": "SERVICES",
    ...
    jp: {
        ...
        "about-stamp": "レコード検証済",
        "about-name": "ZYAD EL AOUAD",
        "about-para-1": "私は、能動的な宇宙デブリ除去や高運動飛行制御ループを専門とする、制御・ナビゲーション・操縦 (GNC) および姿勢決定制御システム (ADCS) のエンジニアです。私の技術的基礎は、欧州宇宙機関 (ESA/ESTEC) での宇宙デブリ安定化則の発表、日本でのハイブリッドロケット燃焼系のシミュレーション、競争力のある学生UAVグループの指導に及びます。",
        "about-para-2": "ボーイングやESAなどの欧州企業航空宇宙標準環境と、九州大学のPlanet Qロケットクラブという熱い学術工学文化の両方で活動してきた経験から、私は大学が教えてくれない実践的なシステムアーキテクチャを教えています。",
        ...
        "teaser-nav-cta": "参加する &rarr;",
        "teaser-telemetry": "起動ベクトル初期化中 // パワーレベル：無制限",
        "teaser-title-1": "BEWINNERENGINEER:",
        "teaser-title-2": "自らの技術を鍛え上げよ。",
        "teaser-desc": "大学は計算方法を教えるが、私たちは生き残り、そして成功する術を教える。次世代の宇宙・システムエンジニアの精鋭たちよ、集え。一般学生から一流システムアーキテクトへ歩みを進めるのだ。",
        "teaser-clock-header": "> TIME_TILL_LAUNCH.EXE",
        "teaser-days": "日",
        "teaser-hours": "時間",
        "teaser-mins": "分",
    ...
    fr: {
        ...
        "about-name": "ZYAD EL AOUAD",
        "about-para-1": "Je suis ingénieur en Guidage, Navigation et Contrôle (GNC) et Systèmes de Détermination et de Contrôle d'Attitude (ADCS), spécialisé dans l'atténuation active des débris spatiaux et les boucles de contrôle de vol à haute dynamique. Mes bases techniques s'étendent de la présentation des lois de stabilisation des débris spatiaux à l'Agence spatiale européenne (ESA/ESTEC), à la simulation de systèmes de combustion de fusées hybrides au Japon, et à la direction de groupes étudiants compétitifs de drones.",
        "about-para-2": "Ayant opéré à la fois dans des environnements aérospatiaux standards d'entreprises européennes (comme les projets Boeing et ESA) et dans la culture intense de l'ingénierie académique de l'Université de Kyushu (Club de fusée Planet Q), j'enseigne l'architecture des systèmes pratique que les universités ignorent.",
        ...
        "teaser-nav-cta": "REJOINDRE &rarr;",
        "teaser-telemetry": "VECTEUR DE DÉPLOIEMENT INITIALISÉ // PUISSANCE : ILLIMITÉE",
        "teaser-title-1": "BEWINNERENGINEER:",
        "teaser-title-2": "FORGEZ VOTRE EXCELLENCE.",
        "teaser-desc": "L'université vous apprend à calculer. Nous vous apprenons à survivre et à exceller. Rejoignez l'élite des futurs ingénieurs systèmes et aérospatiaux. Accélérez votre carrière de simple étudiant à architecte système.",
        "teaser-clock-header": "> TIME_TILL_LAUNCH.EXE",
        "teaser-days": "JOURS",
        "teaser-hours": "HEURES",
        "teaser-mins": "MINUTES",
    ...
    es: {
        ...
        "about-name": "ZYAD EL AOUAD",
        "about-para-1": "Soy ingeniero de Guiado, Navegación y Control (GNC) y Sistemas de Determinación y Control de Actitud (ADCS), especializado en la mitigación activa de basura espacial y bucles de control de vuelo altamente dinámicos. Mi base técnica abarca la presentación de leyes de estabilización de basura espacial en la Agencia Espacial Europea (ESA/ESTEC), la simulación de sistemas de combustión de cohetes híbridos en Japón y la dirección de grupos estudiantiles de UAVs competitivos.",
        "about-para-2": "Habiendo operado tanto en entornos estándares de la industria aeroespacial corporativa europea (como los proyectos Boeing y ESA) como en la intensa cultura de la ingeniería académica de la Universidad de Kyushu (Club de cohetes Planet Q), enseño la arquitectura práctica de sistemas que las universidades omiten.",
...
"dojo-p2-rate": "TARIFA: PLANO PREMIUM",
        ...
        "teaser-nav-cta": "UNIRSE &rarr;",
        "teaser-telemetry": "INICIALIZANDO VECTOR DE LANZAMIENTO // NIVEL DE PODER: ILIMITADO",
        "teaser-title-1": "BEWINNERENGINEER:",
        "teaser-title-2": "FORJA TU EXCELENCIA.",
        "teaser-desc": "La universidad te enseña a calcular. Nosotros te enseñamos a sobrevivir y triunfar. Únete a la cohorte élite de futuros ingenieros aeroespaciales y de sistemas. Acelera tu carrera de estudiante básico a arquitecto de sistemas premium.",
        ...
        "teaser-waitlist-header": "SERVICIOS",
    ...
    ar: {
        ...
        "about-para-1": "أنا مهندس توجيه وملاحة وتحكّم (GNC) وأنظمة تحكّم وتحديد الوضعية (ADCS)، متخخصص فتنقية الحطام الفضائي وأنظمة التحكّم فـ ديناميكيات الطيران العالية. الخبرة ديالي واصلة لتقديم قوانين استقرار الحطام الفضائي فوكالة الفضاء الأوروبية (ESA/ESTEC)، ومحاكاة محركات الصواريخ الهجينة فاليابان، وتسيير مجموعات الدرون للطلبة المنافسين.",
        "about-para-2": "خدمت بزاف مع الشركات الأوروبية الكبرى فالمجال بحال بوينغ (Boeing) ووكالة الفضاء الأوروبية (ESA)، وفي نفس الوقت دزت من الصرامة ديال جامعة كيوشو فاليابان (Planet Q Rocketry Club)، هادشي علاش غنعلمك 'ذكاء السوق والخدمة' اللي ماكيقريوهش فالجامعات.",
        ...
        "teaser-nav-cta": "انضم دابا &rarr;",
        "teaser-telemetry": "البدء فـ توجيه الإطلاق // مستوى الطاقة: غير محدود",
        "teaser-title-1": "BEWINNERENGINEER:",
        "teaser-title-2": "قوّي المهارات ديالك.",
        "teaser-desc": "الجامعة كتقريك كيفاش تحسب، وحنا كنعلموك كيفاش تسلك وتنجح. انضم للنخبة ديال مهندسي الأنظمة والطيران فالمستقبل. زرب الكاريير ديالك من طالب عادي لمهندس أنظمة محترف.",
        ...
        "teaser-waitlist-header": "الخدمات",
